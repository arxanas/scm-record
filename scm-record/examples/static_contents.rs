                ...
                Section::Changed {
                    lines: vec![
                        SectionChangedLine {
                            ...
                            line: Cow::Borrowed("base line 1\n"),
                            group: Some(0),
                        },
                        SectionChangedLine {
                            is_checked: true,
                            change_type: ChangeType::Removed,
                            line: Cow::Borrowed("base line 2\n"),
                            group: Some(0),
                        },
                        SectionChangedLine {
                            is_checked: true,
                            change_type: ChangeType::Added,
                            line: Cow::Borrowed("side 1 line A\n"),
                            group: Some(1),
                        },
                        SectionChangedLine {
                            is_checked: true,
                            change_type: ChangeType::Added,
                            line: Cow::Borrowed("side 1 line B\n"),
                            group: Some(1),
                        },
                        SectionChangedLine {
                            is_checked: true,
                            change_type: ChangeType::Added,
                            line: Cow::Borrowed("side 2 line X\n"),
                            group: Some(2),
                        },
                    ],
                },
